...
(setq llvm-loads "#pragma cling add_include_path(\"/home/chengzhengqian/cloud/cling/cling-2019/cling-src/include\") \n#pragma cling add_library_path(\"/home/chengzhengqian/cloud/cling/cling-2019/llvm_share\")\n#pragma cling load(\"libLLVMRuntimeDyld.so\")\n.L libLLVMExecutionEngine.so\n.L libLLVMObject.so\n.L libLLVMMCJIT.so\n")
;; (setq llvm-loads "#pragma cling add_include_path(\"/home/chengzhengqian/cloud/cling/cling-2019/cling-src/include\")\n")
;; (setq llvm-loads "#pragma cling add_include_path(\"/home/chengzhengqian/share_workspace/llvm/llvm-5.0-shared-library-release/include\") \n#pragma cling add_library_path(\"/home/chengzhengqian/share_workspace/llvm/llvm-5.0-shared-library-release/lib\")\n#pragma cling load(\"libLLVMRuntimeDyld.so\")\n.L libLLVMExecutionEngine.so\n.L libLLVMObject.so\n.L libLLVMMCJIT.so\n")
...
(setq info-path-cling "/home/chengzhengqian/cloud/cling_info")
(setq info-class-path-cling "/home/chengzhengqian/cloud/cling_class_info")
...
(defun get-info-in-cling (command)
  ...
  (save-current-buffer
    (progn
      ...
      (sleep-for 0.01)
      (set-buffer (file-name-base info-path-cling))
...
(defun get-class-member-in-cling-only ()
  ...
  (save-current-buffer
    (progn
      ...
      (term-send-raw-string ".>\n")
      (sleep-for 0.01)
      (set-buffer (file-name-base info-class-path-cling))
      (revert-buffer-no-confirm)
